...
(function () {
  ...
  Surface.prototype.setFill = function (v) { this.manual = v; if (this.start === null) this.start = 0; };
  ...
  Surface.prototype.frame = function (now) {
    ...
    var fill = this.manual != null ? this.manual : this.start === null ? 0 : Math.max(0, (now - this.start) / 1000 / this.duration);
